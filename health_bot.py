...
class HealthBot():
    ...
    def handle_response_from_watson_conversation(self, message, user, conversation_response):
        ...
        # for an action - for example, lookup and return a list of doctors (handleFindFoodByLocationMessage). 
    ...
    def handle_find_doctor_by_location_message(self, conversation_response):
        """
        The handler for the findFoodByLocation action defined in the Watson Conversation dialog.
